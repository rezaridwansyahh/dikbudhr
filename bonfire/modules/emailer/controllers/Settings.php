...
class Settings extends Admin_Controller
{
    ...
    public function send_mail() {
        ...
        $config['smtp_user']    = "yanarazor@gmail.com"; // client email gmail id
        $config['smtp_pass']    = "BapakuSadisudirman@"; // client password
        ...
        $from_email = "yanarazor@gmail.com"; // sender email, coming from my view page 
        $to_email = "yanarazor@gmail.com"; // reciever email, coming from my view page
        //Load email library
