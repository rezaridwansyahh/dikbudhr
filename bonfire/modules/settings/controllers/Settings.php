...
class Settings extends Admin_Controller
{
    ...
    private function saveSettings($extended_settings = array())
    {
        ...
        $data = array(
            ...
            array('name' => 'arsip.disclaimer', 'value' => $this->input->post('disclaimer')),
            array('name' => 'peta.permen', 'value' => trim($this->input->post('peraturan'))),
            array('name' => 'peta_tahun', 'value' => trim($this->input->post('peta_tahun'))),
        );
