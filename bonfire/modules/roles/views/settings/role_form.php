    ...
    <?php echo form_open($this->uri->uri_string(), 'class=""'); ?>
        <fieldset>
            ...
            <div class="control-group<?php echo form_error('role_name') ? ' error' : ''; ?>">
                ...
                <div class="controls">
                    <input type="text" class="form-control" name="role_name" id="role_name" class="input-xlarge" value="<?php echo set_value('role_name', isset($role) ? $role->role_name : ''); ?>" />
            ...
            <div class="control-group<?php echo form_error('login_destination') ? ' error' : ''; ?>">
                ...
                <div class="controls">
                    <input type="text" class="form-control" name="login_destination" id="login_destination" class="input-xlarge" value="<?php echo set_value('login_destination', isset($role) ? $role->login_destination : ''); ?>" />
            ...
            <div class="control-group<?php echo form_error('is_default') ? ' error' : ''; ?>  col-sm-12">
                <label class="control-label" for="default"><?php echo lang('role_default_role'); ?></label>
                <div class="controls">
                    <label class="checkbox" for="default">
                        <input type="checkbox"  name="is_default" id="is_default" value="1" <?php echo set_checkbox('is_default', 1, isset($role) && $role->is_default == 1); ?> />
