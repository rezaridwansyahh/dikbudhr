<fieldset>
    ...
    <div class="control-group<?php echo form_error('title') ? $errorClass : ''; ?>">
        ...
        <div class="controls">
            <input type="text" name="title" class="form-control" id="title" class="span6" value="<?php echo set_value('site.title', isset($settings['site.title']) ? $settings['site.title'] : ''); ?>" />
    ...
    <div class="control-group<?php echo form_error('system_email') ? $errorClass : ''; ?>">
        ...
        <div class="controls">
            <input type="text" name="system_email" class="form-control" id="system_email" class="span4" value="<?php echo set_value('site.system_email', isset($settings['site.system_email']) ? $settings['site.system_email'] : ''); ?>" />
    ...
    <fieldset>
		 ...
		 <div class="control-group">
			 ...
			 <div class="controls">
				 <input type="text" name="pathuploaded" class="form-control" id="KPU" class="span4" value="<?php echo set_value('site.pathuploaded', isset($settings['site.pathuploaded']) ? $settings['site.pathuploaded'] : '') ?>" />
			 </div>
		 </div>
		 <div class="control-group">
			 <label class="control-label" for="title">Url Uploaded</label>
			 <div class="controls">
				 <input type="text" name="urluploaded" class="form-control" id="KPU" class="span4" value="<?php echo set_value('site.urluploaded', isset($settings['site.urluploaded']) ? $settings['site.urluploaded'] : '') ?>" />
			 </div>
		 </div>
	 </fieldset>
</fieldset>