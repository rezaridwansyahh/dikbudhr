...
(function($, window, document, undefined) {
    ...
    var Self, display, videoSelect, lastImageSrc, con, beepSound, w, h, lastCode,
        ...
        defaults = {
            ...
            zoom: 0,
            beep: 'https://data.sdm.kemdikbud.go.id/dikbudhr/themes/admin/assets/qrcode/audio/beep.mp3',
            decoderWorker: 'https://data.sdm.kemdikbud.go.id/dikbudhr/themes/admin/assets/qrcode/js/DecoderWorker.js',
            brightness: 0,
