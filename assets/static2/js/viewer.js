...
//var DEFAULT_URL = '/pdf_docs/' + 'tes.pdf';
var DEFAULT_URL = document.getElementById('nama-file').getAttribute('data-name');
var DEFAULT_PATH = document.getElementById('nama-file').getAttribute('data-path');
//var DEFAULT_URL = 'http://localhost:8080/profile/5c5a5391b1590.pdf';
...
//var tes = DEFAULT_URL.split(":");


PDFJS.imageResourcesPath = './images/';
  PDFJS.workerSrc = DEFAULT_PATH + '/pdf.worker.js';
  PDFJS.cMapUrl = '../web/cmaps/';
  
  //PDFJS.workerSrc = 'http://localhost/dikbudhr/assets/static/build/pdf.worker.js';
  //PDFJS.cMapUrl = '../web/cmaps/';
