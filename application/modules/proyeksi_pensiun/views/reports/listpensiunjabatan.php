...
<div class="admin-box box box-primary">
	<div class="box-header">
        <h3 class="box-title">Estimasi Pegawai Pensiun Tahun <?php echo $tahun; ?> Jabatan  <?php echo isset($nama_jabatan) ? $nama_jabatan : ""; ?></h3>
    </div>
	<div class="box-body">
...
$(".table-data").DataTable({
	...
	serverSide: true,
	ajax: {
	  url: "<?php echo base_url() ?>admin/reports/proyeksi_pensiun/getdatapensiunjabatan/<?php echo $tahun; ?>/<?php echo $jabatan; ?>",
	  type:'POST',
	}
});
