...
<div class="admin-box box box-primary">
	<div class="box-header">
        <h3 class="box-title">Estimasi Pegawai Pensiun Tahun <?php echo $tahun; ?></h3>
    </div>
	<div class="box-body">
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="slug-table table table-bordered table-striped table-responsive dt-responsive table-data table-hover">
				 ...
				 <th>NIP</th>
				 <th>NAMA Pegawai</th>
				 <th>Jabatan <br>(BUP)</th>
				 <th>Tgl Lahir</th>
				 <th>Umur</th>
				 <th>Tahun Pensiun</th>
				 <th>Unit Kerja</th><th width="10px">#</th></tr>
				 </thead>
				 </table>
	<?php
    echo form_close();
...
$(".table-data").DataTable({
	...
	serverSide: true,
	ajax: {
	  url: "<?php echo base_url() ?>admin/reports/proyeksi_pensiun/getdatapensiun/<?php echo $tahun; ?>",
	  type:'POST',
	}
});
