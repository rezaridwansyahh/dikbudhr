...
<div class="callout callout-info">
   <h4>Keterangan</h4>
   <p>Dibawah ini adalah seluruh data pengajuan perpindahan tempat kerja</p>
 </div>
<div class="admin-box box box-primary expanded-box">
	<div class="box-header box-tools">
		<a href="<?php echo site_url($areaUrl . '/createsatu'); ?>" class="btn btn-warning pull-right"><i class="fa fa-plus"></i> Buat Pengajuan Pindah</a>
	</div>
	<div class="box-body">
...
$table = $(".table-data").DataTable({
	...
	ajax: {
	  url: "<?php echo base_url() ?>admin/layanan/pindah_unit/getdatabiro",
	  type:'POST',
	  "data": function ( d ) {
