...
class Riwayat_pekerjaan extends  LIPIAPI_REST_Controller {
    public function __construct(){
     ...
     protected $methods = [
            ...
            'add_riwayat_pekerjaan_post' => ['level' => 0, 'limit' => 10],
            'add_riwayat_pekerjaan_post' => ['level' => 0, 'limit' => 10],
            'del_riwayat_pekerjaan_post' => ['level' => 0, 'limit' => 10],
    ];
    public function list_get(){
        ...
        $this->riwayat_pekerjaan_model->where("PNS_NIP",$NIP); 
        $this->riwayat_pekerjaan_model->ORDER_BY("ID","Desc");
    ...
    public function add_riwayat_pekerjaan_post(){
        ...
        $this->pegawai_model->where("PNS_NIP",$this->input->post("NIP"));
        ...
        $inserted_id =  $this->riwayat_pekerjaan_model->insert($data);
    ...
    public function edit_riwayat_pekerjaan_post(){
        $this->load->model('pegawai/pegawai_model');
        $this->load->model('pegawai/riwayat_pekerjaan_model');
        ...
        if(isset($id_data) && !empty($id_data)){
            $hasil = $this->riwayat_pekerjaan_model->update($id_data,$data);
        }
    ...
    public function del_riwayat_pekerjaan_post(){
        $this->load->model('pegawai/pegawai_model');
        $this->load->model('pegawai/riwayat_pekerjaan_model');
