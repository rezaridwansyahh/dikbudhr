...
<div class="admin-box box box-primary">
	<div class="box-body">
		...
		<table class="slug-table table table-bordered table-striped table-responsive dt-responsive table-matrik-atasan table-hover">
			<thead>
			<tr>
				<th width="5px" style="width:5px">No</th>
				<th>Pegawai</th>
				<th>Proses</th>
				<th>Disetujui</th>
				<th>Perubahan</th>
...
$table_matrik_atasan = $(".table-matrik-atasan").DataTable({
	...
	ajax: {
	  url: "<?php echo base_url() ?>admin/izin/izin_pegawai/getdata_izin_matrik_atasan",
	  type:'POST',
	  "data": function ( d ) {
...
$("#form_search_pegawai").submit(function(){
	$table_matrik_atasan.ajax.reload(null,true);
	return false;
});
