            ...
            <?php echo form_open($this->uri->uri_string(), 'id="frm"'); ?>
                <fieldset>
                    ...
                    <div class="control-group col-sm-6">
                        <label for="inputNAMA" class="control-label">Dari Jam</label>
                        <div class="input-group date">
                            <input id='SELAMA_JAM' type='number' name='SELAMA_JAM' class="form-control"  value="<?php echo set_value('SELAMA_JAM', isset($izin_pegawai->SELAMA_JAM) ? $izin_pegawai->SELAMA_JAM : ""); ?>" />
                            <span class="input-group-addon">WIB</i></span>
                        </div>
                    </div> 
                    <div class="control-group col-sm-6">
                        <label for="inputNAMA" class="control-label">Sampai Jam</label>
                        <div class="input-group date">
                            <input id='SELAMA_MENIT' type='number' name='SELAMA_MENIT' class="form-control"  value="<?php echo set_value('SELAMA_MENIT', isset($izin_pegawai->SELAMA_MENIT) ? $izin_pegawai->SELAMA_MENIT : ""); ?>" />
                            <span class="input-group-addon">WIB</i></span>
                        </div>
                    </div> 
