        ...
        <div class='box box-warning' id="form-riwayat-assesmen-add">
            ...
            <?php echo form_open($this->uri->uri_string(), 'id="frm"'); ?>
                <fieldset>
                    ...
                    <!--
                    <div class="control-group<?php echo form_error('ANAK_KE') ? ' error' : ''; ?>  col-sm-5">
                ...
                -->
                    <div class="control-group col-sm-12">
                        <label for="inputNAMA" class="control-label">PERKIRAAN LAHIR</label>
                        <div class="input-group date">
                          <div class="input-group-addon">
                            <i class="fa fa-calendar"></i>
                          </div>
                            <input type='text' class="form-control pull-right datepicker" name='TGL_PERKIRAAN_LAHIR' id='TGL_PERKIRAAN_LAHIR' value="<?php echo set_value('TGL_PERKIRAAN_LAHIR', isset($izin_pegawai->TGL_PERKIRAAN_LAHIR) ? $izin_pegawai->TGL_PERKIRAAN_LAHIR : ''); ?>" />
                            <span class='help-inline'><?php echo form_error('TGL_PERKIRAAN_LAHIR'); ?></span>
                        </div>
                    </div> 
