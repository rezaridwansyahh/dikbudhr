        ...
        <div class='box box-warning' id="form-riwayat-assesmen-add">
            ...
            <?php echo form_open($this->uri->uri_string(), 'id="frm"'); ?>
                <fieldset>
                    ...
                    <div class="control-group<?php echo form_error('ANAK_KE') ? ' error' : ''; ?>  col-sm-12">
                        <?php echo form_label("Alasan", 'Alasan', array('class' => 'control-label')); ?>
                        <div class='controls'>
                            <select name="ALASAN_CUTI" class="form-control">
                                <option value="">SILAHKAN PILIH</option>
                                <?php
                                if(isset($alasan_izin) && is_array($alasan_izin) && count($alasan_izin)):
                                        foreach ($alasan_izin as $record) {
                                    ?>
                                        <option value="<?php echo $record->ALASAN; ?>" <?php echo $record->ALASAN == $izin_pegawai->ALASAN_CUTI ? "selected" : ""; ?>><?php echo $record->ALASAN; ?></option>
                                    <?php 
                                        }
                                    endif;
                                    ?>
                    ...
                    <div class="control-group<?php echo form_error('ALAMAT_SELAMA_CUTI') ? ' error' : ''; ?>  col-sm-12">
                        ...
                        <div class='controls'>
                            <textarea id='ALAMAT_SELAMA_CUTI' type='text' class="form-control" name='ALAMAT_SELAMA_CUTI'><?php echo set_value('ALAMAT_SELAMA_CUTI', isset($izin_pegawai->ALAMAT_SELAMA_CUTI) ? $izin_pegawai->ALAMAT_SELAMA_CUTI : $alamat_default); ?></textarea>
                    ...
                    <div class="control-group<?php echo form_error('LAMPIRAN_FILE') ? ' error' : ''; ?>  col-sm-9">
                        <?php echo form_label("Lampiran", 'LAMPIRAN_FILE', array('class' => 'control-label')); ?>
                        <div class='controls'>
                                <input id="LAMPIRAN_FILE" name="lampiran" class="file" type="file" data-show-upload="false" data-preview-file-type="pdf" title="Silahkan Pilih file pdf">
                            <span class='help-inline'>*) Hasil pindai atau foto surat keterangan dokter yang memiliki izin praktek yang dikeluarkan oleh pejabatl instansi yang berwenang. Tipe file pdf, jpg, jpeg,png,bmp. Maks. 1 MB</span>
                        </div>
                    </div>
                    <div class="control-group col-sm-3">
                        ...
                        <div class='controls'>
                            ...
                            <?php if(isset($izin_pegawai->LAMPIRAN_FILE) && $izin_pegawai->LAMPIRAN_FILE != ""){ ?>
                                <a url="<?php echo trim($this->settings_lib->item('site.urllampiranizin')).$izin_pegawai->LAMPIRAN_FILE; ?>" class="btn btn-warning popup" tooltip="Lihat dokumen <?php echo isset($izin_pegawai->SK_NOMOR) ? $izin_pegawai->SK_NOMOR : ''; ?>" ><span class="fa fa-file-o"></span> Lihat</a>
                            <?php } ?>  
                        </div>
                    </div>
                </fieldset>
                ...
                <div class="box-footer">
                    <a href="javascript:;" id="btnsavecuti" class="btn green btn-primary button-submit"> 
                        Simpan
