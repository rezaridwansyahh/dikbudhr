            ...
            <?php echo form_open($this->uri->uri_string(), 'id="frm"'); ?>
                <fieldset>
                    ...
                    <div class="control-group col-sm-12">
                        <label for="inputNAMA" class="control-label">NOMOR SURAT</label>
                        <div class="input-group date">
                          <div class="input-group-addon">
                            <i class="fa fa-envelope"></i>
                          </div>
                            <input type='text' class="form-control pull-right" name='NO_SURAT' id='NO_SURAT' value="<?php echo set_value('SAMPAI_TANGGAL', isset($izin_pegawai->SAMPAI_TANGGAL) ? $izin_pegawai->SAMPAI_TANGGAL : ''); ?>" />
                            <span class='help-inline'><?php echo form_error('NO_SURAT'); ?></span>
                        </div>
                    </div>  
                    <div class="control-group col-sm-4">
                        ...
                        <div class="input-group date">
                          <div class="input-group-addon">
                            ...
                            <input type='text' class="form-control pull-right datepicker" readonly name='DARI_TANGGAL' id='DARI_TANGGAL' value="<?php echo set_value('DARI_TANGGAL', isset($izin_pegawai->DARI_TANGGAL) ? $izin_pegawai->DARI_TANGGAL : ''); ?>" />
                    ...
                    <div class="control-group col-sm-4">
                        ...
                        <div class="input-group date">
                          <div class="input-group-addon">
                            ...
                            <input type='text' class="form-control pull-right datepicker" readonly name='SAMPAI_TANGGAL' id='SAMPAI_TANGGAL' value="<?php echo set_value('SAMPAI_TANGGAL', isset($izin_pegawai->SAMPAI_TANGGAL) ? $izin_pegawai->SAMPAI_TANGGAL : ''); ?>" />
