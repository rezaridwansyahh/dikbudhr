        ...
        <fieldset>
            ...
            ?>
                    <div class="control-group<?php echo form_error('ATASAN') ? ' error' : ''; ?> col-lg-7">
                        ...
                        <div class='controls'>
                            <select name="ATASAN_TAMBAHAN[]" width="100%" class="form-control select2 ATASAN">
                                <?php
                                if($record->NIP_ATASAN){
                                    echo "<option selected value='".$record->NIP_ATASAN."'>".$record->NAMA_ATASAN."</option>";
                                }
                                ?>
                            </select>
                    ...
                    <div class="control-group col-lg-2">
                        ...
                        <div class='controls'>
                            <select name="SEBAGAI[]" id="classsebagai" width="100%" class="form-control select2 form-control" required data-minimum=0>
                                <?php 
                                foreach($ajabatan as $row){
                                ?>
                                    <option value="<?php echo $row['id']; ?>" <?php echo $row['id'] == $record->SEBAGAI ? "selected" : ""; ?>><?php echo $row['value']; ?></option>
                                <?php } ?>
                            </select>
...
<script>
   var indexsebagai = 1; 
    ...
    function setatasan(){
        ...
        //alert(post_data);
        var json_url = "<?php echo base_url() ?>admin/izin/izin_pegawai/saveeditpejabat";
        $.ajax({    
            type: "POST",
            url: json_url,
            data: post_data,
            ...
            error: function (e) {
                swal("Pemberitahuan!", "Ada kesalahan, silahkan hubungi admin", "error");
