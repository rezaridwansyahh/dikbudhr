                ...
                <fieldset>
                    ...
                    <div class="control-group<?php echo form_error('ANAK_KE') ? ' error' : ''; ?>  col-sm-12">
                        ...
                        <div class='controls'>
                              <div class="radio">
                                <label>
                                  <input type="radio" name="ALASAN_CUTI" id="optionsRadios1" <?php echo "Ibadah Haji" == $izin_pegawai->ALASAN_CUTI ? "checked" : ""; ?> value="Ibadah Haji">
                                  Ibadah Haji
                                </label>
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <label>
                                  <input type="radio" name="ALASAN_CUTI" id="optionsRadios2" <?php echo "Melahirkan anak keempat dan seterusnya" == $izin_pegawai->ALASAN_CUTI ? "checked" : ""; ?> value="Melahirkan anak keempat dan seterusnya">
                                  Melahirkan anak keempat dan seterusnya
                                </label>
                               &nbsp;&nbsp;&nbsp;&nbsp;
                                <label>
                                  <input type="radio" name="ALASAN_CUTI" id="optionsRadios3" <?php echo "Lainnya" == $izin_pegawai->ALASAN_CUTI ? "checked" : ""; ?> value="Lainnya">
                                  Lainnya
                                </label>
                              </div>
