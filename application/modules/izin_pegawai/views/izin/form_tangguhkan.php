...
<div class="callout callout-success">
   <h4>Perhatian</h4>
   <p>Halaman untuk melakukan penangguhan permintaan izin "<?php echo $nama_izin; ?>" yang sudah disetujui</p>
 </div>
                    ...
                    <div class="control-group<?php echo form_error('STATUS_ATASAN') ? ' error' : ''; ?>  col-sm-12">
                        ...
                        <div class="controls">
                            <select name="STATUS_ATASAN" id="STATUS_ATASAN" class="form-control">
                                ...
                                <option value="3" <?php echo $izin_pegawai->STATUS_PENGAJUAN == "3" ? "selected" : ""; ?> >DISETUJUI</option>
                                <option value="4" <?php echo $izin_pegawai->STATUS_PENGAJUAN == "4" ? "selected" : ""; ?> >PERUBAHAN</option>
                                <option value="5" <?php echo $izin_pegawai->STATUS_PENGAJUAN == "5" ? "selected" : ""; ?>>DITANGGUHKAN</option>
                                <option value="6" <?php echo $izin_pegawai->STATUS_PENGAJUAN == "6" ? "selected" : ""; ?>>TIDAK DISETUJUI</option>
                            </select>
                          </div>
...
<script>
    ...
    function submitdata(){
        var json_url = "<?php echo base_url() ?>admin/izin/izin_pegawai/save_penangguhan";
