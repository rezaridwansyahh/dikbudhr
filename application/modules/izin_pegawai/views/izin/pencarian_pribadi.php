...
<div class="admin-box box box-primary expanded-box">
	...
	<div class="box-body">
		<?php echo form_open($this->uri->uri_string(),"id=form_search_pribadi","form"); ?>
			<style>
			...
			<table class="filter_pegawai" sborder=0 width='100%' cellpadding="10">
				...
				<tr>
					<td><label for="example-text-input" class="col-form-label">Status Pengajuan</label></td>
					<td colspan=2>
						<select name="status_pengajuan" class="form-control">
                            <option value="">Silahkan Pilih</option>
                            <option value="1" <?php echo $izin_pegawai->STATUS_ATASAN == "1" ? "selected" : ""; ?> >PENGAJUAN/MENUNGGU PERSETUJUAN</option>
                            <option value="2" <?php echo $izin_pegawai->STATUS_ATASAN == "2" ? "selected" : ""; ?> >PROSES</option>
                            <option value="3" <?php echo $izin_pegawai->STATUS_ATASAN == "2" ? "selected" : ""; ?> >DISETUJUI</option>
                            <option value="4" <?php echo $izin_pegawai->STATUS_ATASAN == "3" ? "selected" : ""; ?> >PERUBAHAN</option>
                            <option value="5" <?php echo $izin_pegawai->STATUS_ATASAN == "4" ? "selected" : ""; ?>>DITANGGUHKAN</option>
                            <option value="6" <?php echo $izin_pegawai->STATUS_ATASAN == "5" ? "selected" : ""; ?>>TIDAK DISETUJUI</option>
                        </select>
					</td>
				</tr>
				...
				<tr>
					<td colspan=4>
						<button type="submit" class="btn btn-success pull-right btn_cari_pribadi"><i class="fa fa-search"></i> Cari</button>
			...
			<div class="btn-group  pull-right">
              ...
              <button type="button" class="btn btn-info dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                ...
                <span class="sr-only">Toggle Dropdown</span>
              	...
              	<button type="button" class="btn btn-warning pull-right"><a href="<?php echo site_url($areaUrl . '/perizinan/'); ?>">Ajukan Baru</a></button>
              
            </div>
		<table class="slug-table table table-bordered table-striped table-responsive dt-responsive table-data  table-data-pribadi table-hover">
            <thead>
            <tr>
...
$table_pribadi = $(".table-data-pribadi").DataTable({
    ...
    ajax: {
      ...
      type:'POST',
      "data": function ( d ) {
            d.search['advanced_search_filters']=  $("#form_search_pribadi").serializeArray();
        }
    }
});
$("#form_search_pribadi").submit(function(){
	$table_pribadi.ajax.reload(null,true);
	return false;
});
$(".btn_cari_pribadi").submit(function(){
	$table_pribadi.ajax.reload(null,true);
	return false;
});
