 ...
 <div class="tab-pane" id="<?php echo $TAB_ID;?>">
    <div class="nav-tabs-custom">
        <ul id="tab-insides-penilaian" class="nav nav-tabs">
            ...
            <li class="">
                <a href="#<?php echo $tab_pane_rwt_assesmenadmin;?>" data-toggle="tab" aria-expanded="false"> Assesmen Admin</a>
            </li>
            <?php } ?>
            ...
            <li class="">
                <a href="#<?php echo $tab_pane_rwt_nine_box;?>" data-toggle="tab" aria-expanded="false"> Assesmen K </a>
            </li>
