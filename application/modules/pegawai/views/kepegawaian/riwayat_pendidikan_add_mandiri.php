    ...
    <?php echo form_open($this->uri->uri_string(),"id=frmpendidikan","form"); ?>
        <fieldset>
  		...
  		<div class="box-footer">
            <a href="javascript:;" id="btnsave_pendidikan_mandiri" class="btn green btn-primary button-submit"> Kirimkan Data
...
<script>
	...
	$("#btnsave_pendidikan_mandiri").click(function(){
        $('#btnsave_pendidikan_mandiri').text('Sedang Mengirim...');
        $('#btnsave_pendidikan_mandiri').addClass('disabled');
		submitdata();
		return false; 
	});	
	...
	function submitdata(){
		...
		var json_url = "<?php echo base_url() ?>pegawai/riwayatpendidikan/savemandiri";
		 $.ajax({    
		 	type: "POST",
			url: json_url,
			data: the_data,
			...
			success: function(data){ 
                if(data.success){
                    ...
                    $('#btnsave_pendidikan_mandiri').removeClass('disabled');
                    $('#btnsave_pendidikan_mandiri').text('Kirimkan Data');
                }
                else {
                    $('#btnsave_pendidikan_mandiri').removeClass('disabled');
                    $('#btnsave_pendidikan_mandiri').text('Kirimkan Data');
