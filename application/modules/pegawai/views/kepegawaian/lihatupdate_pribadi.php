...
<div class="tab-pane active" id="<?php echo $TAB_ID;?>">
    <div class="callout callout-success">
       <h4>Permintaan perubahan data anda</h4>
     </div>
             ...
             <div class="control-group col-sm-12">
                 <div class="row">
                     ...
                     <div class="form-group col-sm-4">
                        <?php if(isset($dataupdate->STATUS))  echo  ("1"== $dataupdate->STATUS) ? "Diterima" : ""; ?>
                        <?php if(isset($dataupdate->STATUS))  echo  ("2"== $dataupdate->STATUS) ? "Ditolak" : ""; ?>
                     </div>
                     <div class="form-group col-sm-4">
                     </div>
                 </div>
