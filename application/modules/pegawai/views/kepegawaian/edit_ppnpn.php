    ...
    <?php echo form_open($this->uri->uri_string(),'id="frm"'); ?>
        <fieldset>
            ...
            <div class="control-group<?php echo form_error('JABATAN_PPNPN') ? ' error' : ''; ?> col-sm-12">
                ...
                <div class='controls'>
                    <input id='JABATAN_PPNPN' type='text' class="form-control" name='JABATAN_PPNPN' maxlength='50' value="<?php echo set_value('JABATAN_PPNPN', isset($pegawai->JABATAN_PPNPN) ? trim($pegawai->JABATAN_PPNPN) : ''); ?>" />
