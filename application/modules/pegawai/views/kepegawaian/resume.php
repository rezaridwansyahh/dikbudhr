...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/static/pdfjs/viewer.css"/>
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/static/pdf-flip.css"/>
    <style>
        .se-pre-con {
            position: fixed;
            left: 0px;
...
<link rel="resource" type="application/l10n" href="<?php echo base_url(); ?>assets/static/pdfjs/locale/locale.properties"/>
<script src="<?php echo base_url(); ?>assets/static/jquery-2.1.1.min.js"></script>
<script src="<?php echo base_url(); ?>assets/static/turnjs/turn.min.js"></script>
<script src="<?php echo base_url(); ?>assets/static/turnjs/zoom.min.js"></script>
<script src="<?php echo base_url(); ?>assets/static/pdfjs/l10n.js"></script>
<script src="<?php echo base_url(); ?>assets/static/pdfjs/build/pdf.js"></script>
<script src="<?php echo base_url(); ?>assets/static/pdfjs/debugger.js"></script>
<script src="<?php echo base_url(); ?>assets/static/pdfjs/viewer.js" id="nama-file"  data-path="<?php echo $nama_path;?>"  data-name="<?php echo $nama_file; ?>" ></script>
<script src="<?php echo base_url(); ?>assets/static/pdf-flip.js?v=1.1.1.1.1.1"></script>
