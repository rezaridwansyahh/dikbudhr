	...
	<div class="box-body">
        ...
        <fieldset>
            <div class="control-group<?php echo form_error('name') ? ' error' : ''; ?> col-sm-12">
                <?php echo form_label("No Surat", 'name', array('class' => 'control-label')); ?>
                <div class='controls'>
                    <?php echo form_input(array('name' => 'no_surat_pengantar','class'=>'form-control', 'id' => 'no_surat_pengantar', 'rows' => '5', 'cols' => '80')); ?>
...
<script>
	...
	$(document).ready(function(){
        $("#frm-usulan-kpo").submit(function(){
            $.post("<?php echo $module_url?>/do_kirim_usulan",$(this).serialize(),function(o){
                  if(o.success){
