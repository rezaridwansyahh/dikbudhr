<?php 
	$canTambahUsulan	= $this->auth->has_permission('LayananKpo.TambahUsulan');
	$canKirimVerifikatorDeputi	= $this->auth->has_permission('LayananKpo.KirimInboxDeputi');
	$canEdit	= $this->auth->has_permission('LayananKpo.View.PengelolaKPOSatker');
...
<div id="manage_unitkerja_container" class="admin-box box box-primary">
	<div class="box-header">
        <div class="btn-group"  style='float:right'>
			...
			<?php endif; ?>
			<?php if ($canKirimVerifikatorDeputi) : ?>
				<a style="margin-right:10px;" class="btn-kirim-usulan btn btn-small btn-warning" href="<?php echo $module_url; ?>/form_kirim_usulan"><i class="fa fa-arrow-right"></i> Kirim ke Verifikator Deputi</a> 	
			<?php endif; ?>
        </div>
    </div>
	<div class="box-body">
