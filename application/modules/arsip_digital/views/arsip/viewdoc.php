            ...
            <div class="control-group col-sm-2">
                ...
                <div class='controls'>
                    <?php if(isset($arsip_digital->FILE_BASE64) && $arsip_digital->FILE_BASE64 != ""){ ?>
                        <a href="<?php echo base_url(); ?>admin/arsip/arsip_digital/viewdoc/<?php echo $arsip_digital->ID; ?>" class="btn btn-warning modal-custom-global" tooltip='Lihat Dokumen'><span class="fa fa-file-o"></span> Lihat</a>
                    <?php } ?>  
                </div>
            </div> 
        </fieldset>
