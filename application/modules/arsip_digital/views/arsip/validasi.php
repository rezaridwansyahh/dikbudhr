...
<div class="box box-warning admin-box">
    ...
    <?php echo form_open($this->uri->uri_string(),"id=formarsip","form"); ?>
        <fieldset>
            ...
            <div class="control-group<?php echo form_error('ID_JENIS_ARSIP') ? ' error' : ''; ?> col-sm-12">
                ...
                <div class='controls'>
                    ...
                    <input type="hidden" name="NIP" value="<?php echo set_value('NIP', isset($arsip_digital->NIP) ? $arsip_digital->NIP : ''); ?>">
            ...
            <div class="control-group<?php echo form_error('KETERANGAN') ? ' error' : ''; ?> col-sm-12">
                <?php echo form_label("Status Validasi", 'KETERANGAN', array('class' => 'control-label')); ?>
                <div class='controls'>
                    <input type="checkbox" class="form-check-input" <?php echo $arsip_digital->ISVALID == "1" ? "checked" : '' ?> name="ISVALID" value="1" id="ISVALID">
                <label class="form-check-label" for="exampleCheck1">Silahkan Checklist jika dokumen sudah valid</label>
                </div>
            </div>
        </fieldset>
    </div>
    <div class="box-footer">
        <fieldset class='form-actions'>
            <input type='button' name='save' id="btnsavevalidasi" class='btn btn-primary' value="Simpan Dokumen" />
            <?php echo lang('bf_or'); ?>
            <input type='button' name='save' id="btncancelarsip" class='btn btn-warning' value="Cancel" />
        </fieldset>
    </div>
    <?php echo form_close(); ?>
</div>
