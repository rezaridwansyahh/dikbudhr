<?php
$areaUrl = SITE_AREA . '/masters/jenis_satker';
$num_columns	= 2;
$can_delete	= $this->auth->has_permission('Jenis_satker.Masters.Delete');
$can_edit		= $this->auth->has_permission('Jenis_satker.Masters.Edit');
...
<div class="admin-box box box-primary">
	<div class="box-header">
		<h3>
			 <?php if ($this->auth->has_permission('Jenis_satker.Masters.Create')) : ?>
...
var grid_daftar = $(".table-datatable").DataTable({
	...
	serverSide: true,
	ajax: {
	  url: "<?php echo base_url() ?>admin/masters/jenis_satker/ajax_data",
	  type:'POST',
	}
});
...
$('body').on('click','.btn-hapus',function () { 
	...
	function (isConfirm) {
		if (isConfirm) {
			...
			$.ajax({
					url: "<?php echo base_url() ?>admin/masters/jenis_satker/delete",
					type:"POST",
					data: post_data,
					dataType: "html",
					timeout:180000,
