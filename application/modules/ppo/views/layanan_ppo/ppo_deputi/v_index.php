				...
				<table width="100%">
					<tbody>
						<tr>
							...
							<td><select id="filter_unit_kerja" class="select2 form-control lazy-select2" name="filter_unit_kerja"data-minimum=0 data-placeholder='Filter Unit Kerja' data-url='<?php echo base_url('ppo/ppo-deputi/list_satker');?>'></select></td>	
						</tr>
						<tr>
							<td>Status Usulan</td>	
							<td>
								<select id="filter_status" class="select2 form-control lazy-select2" multiple name="filter_status[]" data-minimum=0 data-placeholder='Filter Status' data-url='<?php echo base_url('ppo/ppo-deputi/list_status');?>'>
