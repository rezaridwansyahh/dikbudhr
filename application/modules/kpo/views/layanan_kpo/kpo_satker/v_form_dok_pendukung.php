...
<div class='box box-warning' id="form-diklat-struktural-add">
	...
	<div class="box-body">
        ...
        <table id='table-dokumen' width='100%'>
            <tr>
                <td width=150>Nama Dokumen</td>
                <td><?php echo form_input(array('name' => 'nama_dokumen','class'=>'form-control col-md-8', 'id' => 'no_surat_pengantar')); ?></td>
            </tr>
            <tr>
                <td width=150>Dokumen</td>
                <td><input type="file" class='col-md-8' name="userfile" size="20" /></td>
            </tr>
        </table>
