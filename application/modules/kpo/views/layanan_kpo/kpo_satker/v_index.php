<div id="manage_unitkerja_container" class="admin-box box box-primary">
	<div class="box-header">
        <div class="btn-group"  style='float:right'>
			...
			<?php endif; ?>
			<?php if ($canKirimInboxSekretariat) : ?>
				<a style="margin-right:10px;" class="btn-kirim-usulan btn btn-small btn-warning" href="<?php echo $module_url; ?>/form_kirim_usulan"><i class="fa fa-arrow-right"></i> Kirim ke Inbox Sekretariat</a> 	
			<?php endif; ?>
			<?php if ($canCetak) : ?>
