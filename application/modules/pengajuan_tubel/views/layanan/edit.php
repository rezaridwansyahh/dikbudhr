    ...
    <div class="box-body">
        <?php echo form_open($this->uri->uri_string(), 'class="form-horizontal" id="frm"'); ?>
            <fieldset>
                ...
                <div class="control-group<?php echo form_error('NEGARA') ? ' error' : ''; ?> col-sm-12">
                 ...
                 <div class="control-group col-sm-6">
                    ...
                    <div class="input-group-addon">
                        ...
                        <input type='text' class="form-control pull-right datepicker" name='MULAI_BELAJAR'  value="<?php echo set_value('MULAI_BELAJAR', isset($pengajuan_tubel->MULAI_BELAJAR) ? $pengajuan_tubel->MULAI_BELAJAR : ''); ?>" />
                ...
                <div class="control-group col-sm-6">
                    ...
                    <div class="input-group-addon">
                        ...
                        <input type='text' class="form-control pull-right datepicker" name='AKHIR_BELAJAR'  value="<?php echo set_value('AKHIR_BELAJAR', isset($pengajuan_tubel->AKHIR_BELAJAR) ? $pengajuan_tubel->AKHIR_BELAJAR : ''); ?>" />
            ...
            <fieldset class='form-actions'>
                ...
                <input type='submit' name='save' id="btnsave" class='btn btn-primary' value="Update Pengajuan" />
                <?php echo lang('bf_or'); ?>
                <?php echo anchor('', lang('pengajuan_tubel_cancel'), 'class="btn btn-warning" id="btncancel"'); ?>
