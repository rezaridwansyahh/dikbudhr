		...
		<?php echo form_open($this->uri->uri_string(),"id=form_search_pegawai","form"); ?>
			...
			<table class="filter_pegawai" sborder=0 width='100%' cellpadding="10">
				<tr>
					...
					<td width="80%">
						<select id="unit_id_key" name="unit_id_key" width="100%" class=" col-md-10 format-control"></select>
					</td>
					<td>
				...
				<tr>
					<td width="200px"><label for="example-text-input" class="col-form-label">Pegawai</label></td>
					<td width="80%"><input class="form-control" type="text" name="NIP" value="" ></td>
					<td>
...
$table = $(".table-data").DataTable({
	...
	ajax: {
	  url: "<?php echo base_url() ?>admin/layanan/pengajuan_tubel/getdataadmin",
	  type:'POST',
	  "data": function ( d ) {
