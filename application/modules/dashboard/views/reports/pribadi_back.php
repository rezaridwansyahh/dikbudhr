...
<div class="container">
  <?php
    //var_dump($sk);
    $counter = 0;
    if(sizeof($sk)>0 || $sk!=false){
      echo "<h3><b>Progres SK Berjalan</b></h3>";
      foreach ($sk as $key => $value) {  
        //var_dump($value);  
        if($value->telah_kirim!=1 && date($value->tgl_sk)>="2022-01-01"){
          $counter++;
  ?>
  ...
  <div class="row bs-wizard" style="border-bottom:0;">
    ...
    <div class="box">
      <div class="box-header">
        Progres <?=$value->kategori?>, dengan Nomor <?=$value->nomor_sk?>
      </div>
      ...
      <div class="box-body">
        <div class="col-xs-12">
          <div class="col-xs-3 bs-wizard-step complete">
            ...
            <!-- <div class="bs-wizard-info text-center">Nam mollis tristique erat vel tristique. Aliquam erat volutpat. Mauris
              et
              vestibulum nisi. Duis molestie nisl sed scelerisque vestibulum. Nam placerat tristique placerat
            </div> -->
          </div>

          <div class="col-xs-3 bs-wizard-step <?=$value->is_corrected == 1 || $value->is_signed == 1? 'complete' : 'disabled'?>">
            <div class="text-center bs-wizard-stepnum">Koreksi</div>
            <div class="progress">
              <div class="progress-bar"></div>
            </div>
            <a href="#" class="bs-wizard-dot"></a>
          ...
          <div class="col-xs-3 bs-wizard-step <?=$value->is_signed == 1 ? 'complete' : 'disabled'?>">
          ...
          <div class="col-xs-3 bs-wizard-step <?=$value->telah_kirim == 1 ? 'complete' : 'disabled'?>">
            <div class="text-center bs-wizard-stepnum">SK Dikirim</div>
            <div class="progress">
              <div class="progress-bar"></div>
            </div>
            <a href="#" class="bs-wizard-dot"></a>
          ...
          <table class="table table-bordered">
            ...
            ?>
              <tr>
                ...
                <td><?=$value->is_signed == 1 ? 'Sudah Tanda Tangan' : 'Belum Tanda Tangan' ?></td>
              </tr>
            <?php  
                } 
            ?>
...
$(document).ready(function(){
  ...
  console.log(nip)
  if(nip!=""){
    $.get("https://mutasi.sdm.kemdikbud.go.id/layanan/json/ws_status_proses_ds_layanan_mutasi.php?nip="+nip, function (data) {
      console.log(data);
    });
  }
