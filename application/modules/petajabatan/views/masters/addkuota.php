    ...
    <?php echo form_open($this->uri->uri_string(), 'id="frm"'); ?>
		 <div class="box-body">
            ...
            <div class="control-group<?php echo form_error('JUMLAH_PEMANGKU_JABATAN') ? ' error' : ''; ?> col-sm-10">
                ...
                <div class='controls'>
                    <input type="hidden" name="KODE_UNIT_KERJA" id="KODE_UNIT_KERJA" value="<?php echo $data_unit->ID ? trim($data_unit->ID) : ""; ?>">
...
$("#KODE_UNIT_KERJA1").select2({
    placeholder: 'Cari Unit Kerja...',
    width: '100%',
    minimumInputLength: 0,
    allowClear: true,
    ajax: {
        url: '<?php echo site_url("pegawai/manage_unitkerja/ajax_unit_list");?>',
        dataType: 'json',
