...
class Migration_Install_agama_permissions extends Migration
{
	...
	private $permissionValues = array(
		array(
			'name' => 'Agama.Kepegawaian.View',
			'description' => 'View Agama Kepegawaian',
			'status' => 'active',
		),
		array(
			'name' => 'Agama.Kepegawaian.Create',
			'description' => 'Create Agama Kepegawaian',
			'status' => 'active',
		),
		array(
			'name' => 'Agama.Kepegawaian.Edit',
			'description' => 'Edit Agama Kepegawaian',
			'status' => 'active',
		),
		array(
			'name' => 'Agama.Kepegawaian.Delete',
			'description' => 'Delete Agama Kepegawaian',
			'status' => 'active',
		),
		array(
