...
$(".download_xls").click(function(){
	...
	window.open("<?php echo base_url('admin/kepegawaian/baperjakat/downloadpenetapan/'.$periode);?>?"+xyz);
});
$("#unit_id_key").select2({
...
$table = $(".table-data").DataTable({
	...
	ajax: {
	  url: "<?php echo base_url() ?>admin/kepegawaian/baperjakat/getdatapenetapan/<?php echo $periode; ?>",
	  type:'POST',
	  "data": function ( d ) {
