	...
	<div class="box-body">
		<?php echo form_open($this->uri->uri_string(),"id=form_search_pegawai","form"); ?>
			...
			<table class="filter_pegawai" sborder=0 width='100%' cellpadding="10">
				<tr>
					<td width="100px"><label for="example-text-input" class="col-form-label">Periode</label></td>
					<td width="90%"><input class="form-control" type="text" name="KETERANGAN" value="" ></td>
					<td>
	...
	<div class="box-header box-tools">
			<div class="btn-group pull-right">
			   <?php if ($this->auth->has_permission('Baperjakat.Kepegawaian.Create')) : ?>
					<a class='btn btn-warning' href="<?php echo site_url($areaUrl . '/create'); ?>"><i class="fa fa-plus"></i>Tambah Data</a>
	...
	<div class="box-body">
		<table class="slug-table table table-bordered table-striped table-responsive dt-responsive table-data table-hover">
			...
			<tr>
				...
				<th>NO SK</th>
				<th>STATUS</th>
				<th>JML <br>KANDIDAT</th>
				<th>JML<br>DITETAPKAN</th>
...
$table = $(".table-data").DataTable({
	...
	ajax: {
	  url: "<?php echo base_url() ?>admin/kepegawaian/baperjakat/getdata",
	  type:'POST',
	  "data": function ( d ) {
...
$('body').on('click','.btn-hapus',function () { 
	...
	function (isConfirm) {
		if (isConfirm) {
			...
			$.ajax({
					url: "<?php echo base_url() ?>admin/kepegawaian/baperjakat/deletedata",
					type:"POST",
					data: post_data,
					dataType: "html",
					timeout:180000,
