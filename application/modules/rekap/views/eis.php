...
<script>
    ...
    var loadChartTotalPegawai = function(){
		$.post(BASE_URL+'rekap/eis/ajax_group_by_eselon_total_pegawai',{},function(o){
			...
			$(".chart_total_pegawai.table-data tbody").empty();
			$.each(o,function(i,r){
				$(".chart_total_pegawai.table-data tbody").append("<tr><td>"+r.nama+"</td><td>"+r.total+"</td></tr>");
	...
	var loadChartPendidikanByTK= function(tk_id){
		$.post(BASE_URL+'rekap/eis/ajax_group_by_tk_pendidikan/'+tk_id,{},function(o){
			...
			$(".chart_pendidikan.table-data tbody").empty();
			$.each(o,function(i,r){
				$(".chart_pendidikan.table-data tbody").append("<tr><td>"+r.nama+"</td><td>"+r.total+"</td></tr>");
	...
	var loadChartByUsia= function(usia_id){
		$.post(BASE_URL+'rekap/eis/ajax_group_by_usia/'+usia_id,{},function(o){
			...
			$(".chart_usia.table-data tbody").empty();
			$.each(o,function(i,r){
				$(".chart_usia.table-data tbody").append("<tr><td>"+r.nama+"</td><td>"+r.total+"</td></tr>");
	...
	var loadChartTipeJabatan= function(tipe_jabatan){
		$.post(BASE_URL+'rekap/eis/ajax_group_jabatan/'+tipe_jabatan,{},function(o){
			...
			$(".chart_tipe_jabatan.table-data tbody").empty();
			$.each(o,function(i,r){
				$(".chart_tipe_jabatan.table-data tbody").append("<tr><td>"+r.nama+"</td><td>"+r.total+"</td></tr>");
			});
		},'json');
	}
