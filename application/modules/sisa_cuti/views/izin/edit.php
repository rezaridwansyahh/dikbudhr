    ...
    <?php echo form_open($this->uri->uri_string(), 'id="frm"'); ?>
        <fieldset>
            <div class="control-group<?php echo form_error('PNS_NIP') ? ' error' : ''; ?> col-sm-12">
                ...
                <div class='controls'>
                    <input id='ID' type='hidden' class="form-control" name='ID'  value="<?php echo set_value('ID', isset($sisa_cuti->ID) ? $sisa_cuti->ID : ''); ?>" />
                    <select id="PNS_NIP" name="PNS_NIP" width="100%" class="form-control select2">
                        <?php
                        if($selectedpegawai){
                            echo "<option selected value='".$selectedpegawai->NIP_BARU."'>".$selectedpegawai->NAMA."</option>";
                        }
                        ?>
                    </select>
            ...
            <div class="control-group<?php echo form_error('TAHUN') ? ' error' : ''; ?> col-sm-12">
                ...
                <div class='controls'>
                    <input id='TAHUN' type='number' class="form-control" required='required' name='TAHUN' maxlength='4' value="<?php echo set_value('TAHUN', isset($sisa_cuti->TAHUN) ? $sisa_cuti->TAHUN : ''); ?>" />
