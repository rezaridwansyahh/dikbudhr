...
<div class='admin-box box box-primary'>
    <div class="box-header">
        <h3>Edit Draft SK <?php echo $judul_ttd; ?></h3>
    </div>        
    ...
    <?php echo form_open($this->uri->uri_string(),"id=submit_form","form"); ?>
        <fieldset>
            <input type="hidden" name="id_master_proses" value="<?php echo $id_master_proses; ?>">
            <input type="hidden" name="id" value="<?php echo $draftsk->id; ?>">
            ...
            <div class="control-group col-sm-12">
                ...
                <div class="input-group date">
                  <div class="input-group-addon">
                    ...
                    <input type='text' class="form-control pull-right" id='nip_pemilik_sk' name='nip_pemilik_sk'  value="<?php echo $draftsk->nip_sk; ?>" />
                </div>
            ...
            <div class="control-group col-sm-12">
                ...
                <div class="input-group date">
                  <div class="input-group-addon">
                    ...
                    <input type='text' class="form-control pull-right" id='nama_pemilik_sk' name='nama_pemilik_sk'  value="<?php echo $draftsk->nama_pemilik_sk; ?>" />
                </div>
                <span class='help-inline'></span>
            </div> 
            ...
            <div class="control-group col-sm-6">
                ...
                <div class="input-group date">
                  <div class="input-group-addon">
                    ...
                    <input type='text' class="form-control pull-right datepicker" name='tgl_sk'  value="<?php echo $draftsk->tgl_sk; ?>" />
                </div>
                <span class='help-inline'></span>
            </div> 
            <div class="control-group col-sm-6">
                ...
                <div class="input-group ">
                  <div class="input-group-addon">
                    ...
                    <input type='text' class="form-control pull-right" name='nomor_sk'  value="<?php echo $draftsk->nomor_sk; ?>" />
                </div>
                <span class='help-inline'></span>
            </div> 
            <div class="control-group col-sm-12">
                ...
                <div class="input-group date">
                  <div class="input-group-addon">
                    ...
                    <input type='text' class="form-control pull-right datepicker" name='tmt_sk'  value="<?php echo $draftsk->tmt_sk; ?>" />
                </div>
                        ...
                        <div class="control-group col-sm-12">
                            ...
                            <div class="input-group ">
                              <div class="input-group-addon">
                                ...
                                <input type='text' class="form-control pull-right" name='<?php echo $recordvar->nama_variable; ?>'  value="<?php echo isset($aisivar[$recordvar->id_variable]) ? $aisivar[$recordvar->id_variable] : ""; ?>" />
                            </div>
                            <span class='help-inline'></span>
                        </div> 
                    ...
                    <div class="control-group col-sm-6">
                        ...
                        <div class="input-group date">
                          <div class="input-group-addon">
                            ...
                            <input type='text' class="form-control pull-right datepicker" name='<?php echo $recordvar->nama_variable; ?>'  value="<?php echo isset($aisivar[$recordvar->id_variable]) ? $aisivar[$recordvar->id_variable] : ""; ?>" />
                        </div>
            ...
            ?>
            <div class="control-group<?php echo form_error('dokumen') ? ' error' : ''; ?> col-sm-12">
                <?php echo form_label("Dokumen", 'dokumen', array('class' => 'control-label')); ?>
                <div class='controls'>
                    <div id="form_upload">
                        <input id="nama_sk" name="nama_sk" class="file" type="file" data-preview-file-type="pdf" data-show-upload="false" title="Silahkan Pilih file">
                      </div>
            
                    <span class='help-inline'>silahkan pilih dokumen pdf jika dokumen sudah dibuat sebelumnya</span>
                </div>
            </div>
            <div class="control-group<?php echo form_error('template_sk') ? ' error' : ''; ?> col-sm-4">
                <?php echo form_label("<br>", 'template_sk', array('class' => 'control-label')); ?>
                <div class='controls'>
                    <?php if($draftsk->id_master_proses != "" && $draftsk->base64pdf_hasil == ""){ ?>
                    <a href="<?php echo base_url(); ?>admin/tte/tte/downloadsk/<?php echo $draftsk->id; ?>" class="btn btn-warning"> <i class="fa fa-download"></i> Doc Template</a>

                    <a href="<?php echo base_url(); ?>admin/tte/tte/viewdoc/<?php echo $draftsk->id_file; ?>" class="btn btn-danger show-modal"> <i class="fa fa-download"></i> Pdf Template</a>

                    <?php } ?>

                    <?php if($draftsk->base64pdf_hasil != ""){ ?>
                    <span url="<?php echo base_url(); ?>admin/tte/tte/viewpdf/<?php echo $draftsk->id; ?>" class="btn btn-warning popupurl"> <i class="fa fa-eye"></i> pdf</span>
                    <?php } ?>
                </div>
            </div>
        </fieldset>
            ...
            <div class="control-group <?php echo form_error('verifikator') ? ' error' : ''; ?> col-sm-8" id="divv_<?php echo $no; ?>">
                ...
                <div class='controls'>
                    <select name="halaman_ttd" width="100%" class="form-control select2">
                        <option value="1" <?php echo $draftsk->halaman_ttd== "1" ? "selected" : ""; ?>>PERTAMA</option>
                        <option value="2" <?php echo $draftsk->halaman_ttd== "2" ? "selected" : ""; ?>>TERAKHIR</option>
                    </select>
                </div>
            </div>
            <div class="control-group <?php echo form_error('verifikator') ? ' error' : ''; ?> col-sm-8" id="divv_<?php echo $no; ?>">
                ...
                <div class='controls'>
                    <select name="show_qrcode" width="100%" class="form-control select2">
                        ...
                        <option value="1" <?php echo $draftsk->show_qrcode== "1" ? "selected" : ""; ?>>Tampilkan</option>
                    </select>
                </div>
            </div>
            <div class="control-group <?php echo form_error('letak_ttd') ? ' error' : ''; ?> col-sm-8" id="divv_<?php echo $no; ?>">
                ...
                <div class='controls'>
                    <select name="letak_ttd" width="100%" class="form-control select2">
                        ...
                        <option value="1" <?php echo $draftsk->letak_ttd == "1" ? "selected" : ""; ?>>Tengah Bawah</option>
                        <option value="2" <?php echo $draftsk->letak_ttd == "2" ? "selected" : ""; ?>>Kiri Bawah</option>
                    </select>
                </div>
            </div>
        ...
        <fieldset id="formveririkator">
            ...
            <?php if (isset($verifikators) && is_array($verifikators) && count($verifikators)):?>
                ...
                <?php foreach($verifikators as $recordvar):?>
                    ...
                    <div class="control-group<?php echo form_error('verifikator') ? ' error' : ''; ?> col-sm-3" id="divv2_<?php echo $no; ?>">
            ...
            <div class="box-footer">
                <div class="message"></div>
            <input type='button' name='save' id="btn_save" class='btn btn-primary' value="Simpan Dokumen" />
...
$("#nip_sk").change(function(){
  ...
  var nomor  = 1;
  var nomorv = <?php echo count($verifikators); ?>;
  function submitdata(){
...
$('body').on('click','#addverifikator',function () { 
    nomorv++;
    var s = "<div class=\"control-group col-sm-8\"><label for=\"variable1\" class=\"control-label\">Verifikator "+nomorv+" </label><div class=\"controls\"><select name=\"verifikator[]\" id=\"selectv_"+nomorv+"\" width=\"100%\" class=\"form-control select2 class_verifikator\"></select></div></div>";
